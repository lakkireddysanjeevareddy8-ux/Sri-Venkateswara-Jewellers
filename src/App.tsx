  ...
  return (
    ...
    >
      ...
      {settings && !isAdminPanelOpen && !selectedProduct && (
        <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3 items-end" style={{ pointerEvents: 'auto' }}>
          {/* WhatsApp Button */}
          {whatsAppNumbers.length > 0 && (
            <motion.a
              ...
              className="group flex items-center gap-2 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer"
            ...
            >
              <span className="hidden group-hover:inline-block text-white text-xs font-bold pl-4 pr-1 whitespace-nowrap">
                Chat with us
              </span>
              <span className="flex items-center justify-center w-14 h-14 rounded-full" style={{ background: '#25D366' }}>
          ...
          {settings.shop_phone && (
            ...
            >
              ...
              <span className="flex items-center justify-center w-14 h-14 rounded-full" style={{ background: primaryColor }}>
