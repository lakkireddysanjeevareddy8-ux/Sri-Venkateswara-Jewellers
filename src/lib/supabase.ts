...
const DEFAULT_SETTINGS: StoreSettings = {
  ...
  ad_title: 'Unveiling: The Royal Nizam Antique Kundan Haram',
  ad_text: 'Introducing our newly added 22K Royal Nizam Antique Kundan Haram. Handcrafted with traditional precision and authentic BIS Hallmarking. Explore the master craftsmanship now!',
  ad_product_id: 'prod-1',
