      ...
      {activeProfile && (
        <div className="flex border-b border-stone-200 bg-white shrink-0">
          <button
            ...
            className={`flex-1 py-3 text-xs font-bold uppercase tracking-wider font-mono border-b-2 transition-all flex items-center justify-center gap-2 cursor-pointer ${
              activeTab === 'profile'
